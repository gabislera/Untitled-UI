      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col leading-relaxed">
            <span className="dark:text-error-400 text-error-700 text-sm font-medium ">
          ...
          <button
            type="button"
            className="hover:text-error-900 dark:text-error-400 dark:hover:text-error-300 text-error-700 text-sm font-semibold"
          >
            Try again
          </button>
        </div>
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          ...
          <div className="flex w-full items-center gap-3">
            <div className="h-2 flex-1 rounded-full bg-zinc-100">
              <div
                className="roundedfull h-2 bg-violet-600"
